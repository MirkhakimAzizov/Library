      ...
      <div className="flex items-center justify-evenly">
        ...
        <div className="hidden xl:block">
          <div className="relative">
            <Link to={"/"} className="flex w-full justify-center rounded-md bg-blue-600	 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">Kirish</Link>
          </div>
        </div>
      </div>
      <hr />
          ...
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li className="mx-5">
                <NavLink
                  to="/shop"
                  className="block py-2 px-3 text-white hover:text-[#F65D4E] rounded  md:p-0 "
                  activeClassName="active"
                  aria-current="page"
                >
                  Kitoblar
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 w-full ml-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div className="mb-6 md:mb-0">
              <a href="/" className="">
                <img
                  ...
                  alt="FlowBite Logo"
                />
                <span className="text-[#F65D4E]">MRDI</span>
              </a>
              <br />
              <br />
              <p className="text-gray-300 w-[60%]">
                {" "}
                Toshkent shahri Mironshox ko'chasi 123-uy
              </p>
              <br />
              <br />
              <div className="flex gap-3">
                ...
                <span className="elementor-grid-item">
                  <a
                    href="https://www.facebook.com/mrdi"
                    target="_blank"
                  >
                    <i className="fab fa-facebook hover:text-[#F65D4E] hover:text-sm"></i>{" "}
                  </a>
                ...
                <span className="elementor-grid-item">
                  <a
                    href="https://www.instagram.com/mrdi"
                    target="_blank"
                  >
                    <i className="fab fa-instagram hover:text-[#F65D4E] hover:text-sm"></i>{" "}
                  </a>
            ...
            <div className="pt-6">
              ...
              <p className="text-lg mt-5">info@mrdi.uz</p>
            </div>
            <div>
              <h3 className="text-lg pt-6">Menu:</h3>
          ...
          <div className="md:w-full flex justify-center">
            <p className="text-center">
              MRDI - Barcha huquqlar himoyalangan
            </p>
          </div>
        </div>
      </footer>
