...
function Home() {
  ...
  return (
    <>
      <section className="mt-0" id="hero-area">
        <div className="flex h-full items-center justify-end mx-[15%]">
          <div className="relative">
            <p class="text-center">Kutubxona</p>
            <h1 className="relative z-10 font-bold leading-normal text-4xl md:leading-normal lg:text-5xl">
              Siz Izlayotgan <br /> Kitoblar Shu Yerda{" "}
            </h1>
            <img
              src={require("../images/revslider_vector.png")}
              alt=""
              className="absolute postion-style mt-10"
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="p-8 text-left items-center gap-5 border border-gray rounded-xl flex">
              ...
              <div>
                ...
                <h4 className="text-lg text-gray-500">Kitobxonlar</h4>
              </div>
            </div>
            <div className="p-8 text-left items-center gap-5 border border-gray rounded-xl flex">
              <button
